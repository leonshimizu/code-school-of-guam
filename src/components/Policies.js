...
function Policies() {
  return (
    <section id="policies" className="policies">
      ...
      <p>
        We collect personal information during enrollment and coursework to enhance your learning experience. This information is used solely for educational and administrative purposes. By enrolling, you consent to the collection and use of your data as described.
      </p>
    </section>
  );
}
