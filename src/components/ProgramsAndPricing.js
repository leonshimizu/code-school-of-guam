    ...
    <section id="programs-pricing" className="programs-pricing">
      ...
      <div className="programs-content">
        <div className="program-item">
          ...
          <p className="price"><strong>Cost:</strong> $5,000</p>
          <p>
            <em>Limited-time offer to refine our curriculum with your valuable feedback.</em>
          </p>
        </div>
        ...
        <div className="program-item">
          ...
          <p>
            <strong>Features:</strong> Access to recorded lessons, mandatory weekly 1-hour instructor meetings, and weekly project submissions. Receive feedback and guidance throughout the program.
          </p>
