  ...
  return (
    <section id="about" className="about">
      ...
      <p>
        ...
        in the global software industry. By building a pipeline of tech talent, we aim to contribute to the island's economic growth and innovation.
      </p>

      <h3>Why Code School of Guam?</h3>
      <p>
        At Code School of Guam, we prioritize hands-on learning and mentorship. Our classes are intentionally kept small (max 10 students per class)
        to ensure personalized attention and support for every student. This allows students to build strong relationships with their instructors and peers,
        fostering a collaborative learning environment where everyone is set up for success.
      </p>
